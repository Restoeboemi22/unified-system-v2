...
// Also wrap it in GasLegacyLayout safely
// Find the `return (` of the `GasSuperAdminServiceStatusPage` component.
const componentStart = content.indexOf('export default function GasSuperAdminServiceStatusPage');
const returnIndex = content.indexOf('return (', componentStart);

content = content.substring(0, returnIndex) + 'return (\\n    <GasLegacyLayout>\\n' + content.substring(returnIndex + 9);
...
// fix the string interpolation in node script string, removing \\n escaping issue
