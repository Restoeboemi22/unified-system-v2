const ROLE_CAPABILITIES: Record<string, string[]> = {
  ...
  super_admin: ["admin.read", "school.read", "school.manage", "service_status.manage", "student.manage", "staff.manage", "teacher.manage", "principal.manage", "classroom.manage", "academic_period.manage", "academic-directory.read"],
